...
function createStatusbar(obj)
{
	 ...
	 this.description = $("<div class='description'><textarea rows='3' id='desc'></textarea></div>").appendTo(this.statusbar);
...
function handleFileUpload(files,obj)
{
   ...
   for (var i = 0; i < files.length; i++)
   {
		...
		if(name.indexOf("2") >= 0) {
			...
			$("#nextHref").removeAttr("href");
			$("#nextHref").attr("href", "6-ebf-list-view-upload.html?status=file-upload");
		}
