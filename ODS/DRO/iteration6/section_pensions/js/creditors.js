...
$("#row-9").hide();
 ...
 var pensiontypeahead = $('#pension.typeahead');
	pensiontypeahead.typeahead({
	  hint: true,
	  highlight: true,
	  minLength: 1
	},
	{
	  ...
	  source: pension.ttAdapter()
	});
var defaultnext = $("#next").prop("href");

var pensionSelectedHandler = function (eventObject, suggestionObject, suggestionDataset) {
	$("#next").prop("href", "2.html?address=known");

};

pensiontypeahead.on('typeahead:selected', pensionSelectedHandler );

$("#pension").on("change", function(){
	$("#next").prop("href", defaultnext);

	if (pensiontypeahead.typeahead('val') == ""){
	    /*$("#pnl-name").text("");
    	$("#pnl-address").text("");
    	$("#pnl-creditor").hide();*/
	}
...
function clearfilter(){
	pensiontypeahead.typeahead('val', '');
/*	    $("#pnl-name").text("");
    	$("#pnl-address").text("");
    	$("#pnl-creditor").hide();*/
}
